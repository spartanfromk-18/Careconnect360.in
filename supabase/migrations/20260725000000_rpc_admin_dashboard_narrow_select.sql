-- 20260725000000_rpc_admin_dashboard_narrow_select.sql
-- Replace SELECT * with explicit column lists in admin_dashboard_data RPC.
-- Only selects columns actually rendered by the admin dashboard UI.
